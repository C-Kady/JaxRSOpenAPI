...
3. Ou sinon creer juste une BD nommée mydatabase dans votre SGBD et c'est bon
4. Et maintenant lancer la classe jpaTest pour effectuer les migratons
5. Déployer sur le serveur en faisant un RUN dans la classe RestServer
